...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <h3 class="text-center">Modificação Professores</h3>
        </div>
        <?php
        include "conexao.php";

        $result = $conn->query(
            "SELECT matricula_professor, des_nome, cod_genero, des_email FROM professor WHERE matricula_professor = " . $_GET["matricula_professor"]);
        ...
        ?>
            ...
            <form method="post" action="updProfessor.php">
            <div class="form-group row">
                <div class="col-md-2">
                    ...
                    value="<?=$_GET["matricula_professor"];?>" readonly/>
                </div>
                <div class="col-md-6">
                    <label for="pnome">Nome:</label>
                    <input type="text" class="form-control" id="pnome" name="pnome" placeholder="Nome do Professor"
                    value="<?=$row["des_nome"];?>"/>
                </div>  
                <div class="col-md-2">
