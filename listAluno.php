...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <h3 class="text-center">Manutenção Aluno</h3>
            <?php
            include "conexao.php";

            $select = "SELECT cod_matricula, des_nome, cod_genero, num_cep, des_email, id_curso FROM aluno";
...
?>
        ...
        <p class="text-center">
            <a href="incAluno.html" class="btn btn-success">&nbsp; Adicionar &nbsp;</a>
        </p>
    </div>
